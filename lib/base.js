(function() {
  ...
  // Require the Q.js promise library
  // Require the query.js promise library
  require.config({
    paths:{
  ...
  define(['module', 'underscore', './platform', 'q', 'zepto', 'zeptodata'], function(module, _, platform, Q, Zepto, ZeptoData) {
